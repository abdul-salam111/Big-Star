import 'package:auction_app/app/modules/display_products/displayTrucks/views/display_truck_details.dart';
import 'package:auto_size_text_pk/auto_size_text_pk.dart';

import '../../../modules.dart';
import '../controllers/display_trucks_controller.dart';

class DisplayTrucksView extends GetView<DisplayTrucksController> {
  const DisplayTrucksView({super.key});
  @override
                  ...
                  child: RefreshIndicator(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        var truck = controller.paginatedData[index];
                        return Container(
                          decoration: BoxDecoration(
                            color: index % 2 != 0
                                ? Color(0xffF5F7FA)
                                  ...
                                  SizedBox(
                                    ...
                                    child: Obx(
                                      () => IconButton(
                                        ...
                                        onPressed: () {
                                          controller.toggleExpandRow(truck.id!);
                                        },
                                      ),
                                    ),
                                  ),
                                  ...
                                  child: Row(
                                    children: [
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          color: truck.status == "Outofstock"
                                              ? Colors.red[100]
                                              : truck.status == "Instock"
                                                  ? Colors.green[100]
                                                  : Colors.grey[200],
                                          border: Border.all(
